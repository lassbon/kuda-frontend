  ...
  return (
    <div className='font-Mulish  '>
      <nav className='bg-white flex justify-between items-center px-[3rem] py-[1rem] drop-shadow-md'>
        ...
        <div className='flex gap-x-8'>
          ...
          <div className='flex items-center'>
            ...
            <a
              className='text-[#b2a2c4] mx-[1rem]'
              href='https://app.kuda.com/dashboard/investments'
            >
              Invest
            </a>
      ...
      <div className='flex justify-center'>
        <div>
          <h1 className='font-bold text-[2rem] mt-[3rem] text-[#411a6e]'>
            Invest
          </h1>
        </div>
      </div>
        ...
        <div className='w-[50rem]'>
          ...
          <div className='flex  justify-between gap-x-7 '>
            <div className=' items-center bg-white drop-shadow-md rounded-[0.5rem] w-[35rem] h-[22rem] mt-[2rem] '>
              <h1 className='font-bold text-[2rem] mt-[3rem] text-[#411a6e] text-center'>
                Invest with Kuda
              </h1>
              <img src={invest_logo} alt='' className='w-[8rem] mx-auto ' />
              <p className='w-[18rem] text-[1rem] mx-auto'>
                Choose an option to grow your money. Please, remember that
                investments fluctuate and Kuda doesn’t give investment advice.
              </p>
            </div>
            <div className='flex flex-col bg-white drop-shadow-md rounded-[0.5rem] gap-y-9 h-[18rem] '>
              <div className='flex  justify-between items-center bg-white drop-shadow-md rounded-[0.5rem] w-[25rem]'>
                <div className=''>
                  <h6 className='font-bold text-[1rem] mt-[3rem] text-[#411a6e] text-center'>
                    US Stocks
                  </h6>
                  <p className='text-[0.7rem] text-center'>
                    Trade thousands of US stocks with as little as $10.
                  </p>
                </div>
                <img
                  src={social_media}
                  alt=''
                  className='w-[4rem] mx-[5rem] '
                />
              </div>
              <div className='flex flex-col bg-white drop-shadow-md rounded-[0.5rem] w-[25rem] h-[10rem]'>
                <div className=''>
                  ...
                  <div className='flex bg-white drop-shadow-md rounded-[0.5rem]'>
                    <div className=''>
                      <p className='mx-[2rem] mt-[1rem] text-white  bg-yellow-400 p-[0.1rem] mx-[0.2rem] rounded-[0.2rem]'>
                        Coming Soon
                      </p>
                      <h6 className='font-bold text-[1rem] mt-[0rem] text-[#411a6e] mx-[2.1rem]'>
                        Managed Funds
                      </h6>
                      <p className='text-[0.7rem] mx-[1.7rem]'>
