...
function PayContainer() {
  return (
    <div className='flex justify-center gap-x-8 mb-10'>
      <a
        href='#'
        className='flex items-center bg-white drop-shadow-xl py-[0.5rem] px-[0.6rem] rounded-[0.5rem] '
      >
      ...
      <a
        href='#'
        className='flex text-[#b4b4b4] items-center bg-white drop-shadow-xl py-[0.5rem] px-[0.6rem] rounded-[0.5rem]'
      >
